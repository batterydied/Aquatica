...
export class AuthPage extends BaseComponent {
  ...
  /* 1. Register Page: allows new users to register by submitting their email and password.
...
/* 3. NOT_IMPLEMENTED_ON_PROFILE_PAGE_Logout Button: allows users to log out by invalidating their authentication token.
  ...
  -Using email validation: using the code sent to email for validate, or 
...
/* Coder Note
  ...
  *Logic:
    - Create UI forms for registration and login.
