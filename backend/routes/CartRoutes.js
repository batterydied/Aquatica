/**
 * CartRoutes: Devin
 * Description: This file defines the API endpoints for managing cart-related 
 *              operations. It maps HTTP requests to the corresponding methods
 *              in the `CartController`, enabling interaction between the frontend
 *              and the backend for cart functionality.
 * Issue: #51
 * Owner: Devin
 * Expected Outcome: A fully functional and modular routing system that
 *                   handles cart-related requests like adding, removing,
 *                   saving, and fetching cart items.
 */
